...
<section id="section1" class="h-screen">
    <div class="grid grid-cols-2 place-items-center h-full pb-20">
        <div>
            <img class="ml-40 object-cover h-60" src="{{ URL::asset('images/plante.png') }}" alt="Nothing">
        </div>
        <div class="w-6/12">
...
<section id="section2" class="h-screen">
    <div class="grid grid-cols-3 place-items-center h-full">
        <div class="grid place-items-center w-3/4 h-3/4  bg-gray-200 hover:bg-white rounded-lg shadow-2xl">
            <div>
                <img class="h-40 mb-20" src="{{ URL::asset('images/microchipv2.png') }}" alt="Nothing">
                <p class="text-center text-xl font-bold">COMPOSANTS</p>
            </div>
        </div>
        <div class="grid place-items-center w-3/4 h-3/4 bg-gray-200 hover:bg-white rounded-lg shadow-2xl">
            <div>
                <img class="h-40 mb-20" src="{{ URL::asset('images/temperature-sensorv2.png') }}" alt="Nothing">
                <p class="text-center text-xl font-bold">CAPTEURS</p>
            </div>
        </div>
        <div class="grid place-items-center w-3/4 h-3/4 bg-gray-200 hover:bg-white rounded-lg shadow-2xl">
            <div>
                <img class="h-40 mb-20" src="{{ URL::asset('images/analyticsv2.png') }}" alt="Nothing">
...
<section id="section3" class="h-screen">
    <div class="grid grid-cols-3 place-items-center h-full">
        <div>
            <img class="h-40" src="{{ URL::asset('images/giftbox.png') }}" alt="Nothing">
        </div>
        <div class="col-span-2 grid place-items-center w-10/12 h-2/3 rounded-lg shadow-2xl">
            <form-precommande 
                fill-input-card="{{ session('card_number') }}"
                fill-input-sector="{{ session('sector_activities') }}"
                fill-input-machine="{{ session('nb_machine') }}"
                fill-input-date="{{ session('date_expiration') }}"
                fill-input-cvv="{{ session('cvv') }}"
            >
            </form-precommande>
        </div>
    </div>
...
<section id="section4" class="h-screen x-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
    <div class="grid grid-cols-1 place-items-center h-full sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-20">
        <div class="w-3/4 h-3/5 shadow-2xl rounded-lg p-12 flex flex-col justify-center items-center">
            <div class="mb-10">
                <img class="object-center object-cover rounded-full h-36 w-36" src="{{ URL::asset('images/nico.jpg') }}" alt="photo">
            </div>
        ...
        <div class="w-3/4 h-3/5 shadow-2xl rounded-lg p-12 flex flex-col justify-center items-center">
            <div class="mb-10">
                <img class="object-center object-cover rounded-full h-36 w-36" src="{{ URL::asset('images/ben2.png') }}" alt="photo">
            </div>
            <div class="text-center mb-10">
        ...
        <div class="w-3/4 h-3/5 shadow-2xl rounded-lg p-12 flex flex-col justify-center items-center">
            <div class="mb-10">
                <img class="object-center object-cover rounded-full h-36 w-36" src="{{ URL::asset('images/jo.png') }}" alt="photo">
            </div>
            <div class="text-center mb-10">
